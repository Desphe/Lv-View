...
export async function loadInitData(params) {
  return request(`/menuManage/menuManage?${stringify(params)}`);
}
export async function loadInitFields(params) {
  return request(`/menuManage/menuManage/get?${stringify(params)}`);
}
// 获取分页数据
